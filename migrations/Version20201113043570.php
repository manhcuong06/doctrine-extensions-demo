 ...
 */
final class Version20201113043570 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Tables translatables and ext_translations';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE translatables (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(128) NOT NULL, content VARCHAR(128) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE translatables');
    }
}
